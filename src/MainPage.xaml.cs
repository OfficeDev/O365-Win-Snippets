...
namespace O365_Win_Snippets
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void CreateTestList()
        {
            ...
            StoryCollection.Add(new StoryDefinition() { GroupName = "Email", Title = "Get Attachments", RunStoryAsync = EmailStories.TryGetFileAttachmentsAsync });
            StoryCollection.Add(new StoryDefinition() { GroupName = "Email", Title = "Get Web Link", RunStoryAsync = EmailStories.TryGetMessageWebLinkAsync });
